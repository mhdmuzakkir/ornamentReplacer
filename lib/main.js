...
(function() {
    ...
    function updateProgressOverlay(chunkIdx, totalChunks, currentFile, processed, errors, totalFiles) {
    ...
    function processBatchFolderByFolder(options, filesToProcess, resumeState) {
        ...
        function processNext() {
            ...
            updateProgressOverlay(current + 1, chunks.length, currentFileName, totalProcessed, totalErrors, filesToProcess.length);
            ...
            csInterface.evalScript(script, function(result) {
                ...
                current++;
                if (current < chunks.length) {
                    updateProgressOverlay(current, chunks.length, 'Resting...', totalProcessed, totalErrors, filesToProcess.length);
